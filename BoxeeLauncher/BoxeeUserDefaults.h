...
extern NSString* const Boxee_USE_INTERNAL_IR; //NSBool
extern NSString* const Boxee_USE_UNIVERSAL_REMOTE; //use appleremote in universal mode

@interface BoxeeUserDefaults : NSUserDefaults {
