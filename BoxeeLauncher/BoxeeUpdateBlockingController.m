//
//  BoxeeUpdateBlockingController.m
//  BoxeeLauncher
//
...
@implementation BoxeeUpdateBlockingController
...
//	[[self stack] popController];
	[[self stack] swapController: [BRAlertController alertOfType:0 titled:@"Update finished!" primaryText:@"Select the menu button to return" secondaryText:nil]];
}
