...
NSString* const Boxee_USE_INTERNAL_IR = @"UseInternalIR";
NSString* const Boxee_USE_UNIVERSAL_REMOTE = @"UseBoxeesUniversalRemote";

@implementation BoxeeUserDefaults
...
{
	static BoxeeUserDefaults* sl_defaults = nil;
	if( ! sl_defaults )
		sl_defaults = [[self alloc] initWithPersistentDomainName:@"tv.boxee.boxeelauncher"];
	return sl_defaults;
