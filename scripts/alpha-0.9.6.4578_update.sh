...
if [ -e $DISKIMAGE ]; then
  ...
  echo $PW | sudo -S installer -pkg /Volumes/boxee-0.9.6/boxee-0.9.6.4578.mpkg -target /
  echo $PW | sudo -S hdiutil detach /Volumes/boxee-0.9.6
  ...
  # clean up
  #if [ -e /Users/Frontrow/Movies/boxee-0.9.6.4578 ]; then
  # something makes this symlink during install so zap it.
  echo $PW | sudo -S rm /Users/Frontrow/Movies/boxee-0.9.6.4578
  #fi
