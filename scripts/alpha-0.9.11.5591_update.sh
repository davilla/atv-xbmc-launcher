...
if [ -e $DISKIMAGE ]; then
  ...
  echo $PW | sudo -S installer -pkg /Volumes/boxee-0.9.11/boxee-0.9.11.5591.mpkg -target /
  ...
  sed -i"" -e 's/rendermethod>0/rendermethod>2/g' "/Users/frontrow/Library/Application Support/BOXEE/UserData/guisettings.xml"
  ...
  # clean up
  #if [ -e /Users/Frontrow/Movies/boxee-0.9.11.5591 ]; then
  # something makes this symlink during install so zap it.
  echo $PW | sudo -S rm /Users/Frontrow/Movies/boxee-0.9.11.5591
  #fi
